...
See the [Quick Start Guide](./riper_docs/quickstart.md) for instructions on enabling GitHub, Web Search, Browser Automation, and Docker integrations.

### Optional: Enable BMAD Enterprise

Refer to the [BMAD Integration Guide](./riper_docs/bmad_integration_guide.md) for guidance on adopting enterprise features, including roles, PRDs, and quality gates.
...
See [Protection Commands](./riper_docs/ProtectionCommands.md) for complete documentation.
...
See [Context Usage Guide](./riper_docs/howto_context.md) for more details.
...
See [Permission Reference](./riper_docs/permission_reference.md) for quick reference.
...
See the [Symbol Reference Guide](./riper_docs/symbol-reference-guide.md) (v3.0) for a complete list of symbols and notation used in the framework, including:
...
## Leveraging `Gemini CLI` for Large-Scale Analysis

When dealing with large file volumes or extensive text analysis, utilize Gemini CLI's large context capabilities:

- **Large Codebase Analysis**: Understanding entire project structures or architectures through parallel processing
- **Multi-file Comparison**: Analyzing patterns or dependencies across files
- **Long Document Summarization**: Processing large documents or log files
- **Implementation Verification**: Checking if specific features or security measures are implemented

For detailed usage, refer to [USE_GEMINI_CLI](./riper_docs/use_gemini_cli.md). This file includes `@` syntax for file inclusion, various analysis examples, and guidance on when Gemini CLI is most suitable.

## 📋 Additional Resources

- [Quick Start Guide](./riper_docs/quickstart.md) - Get started in 5 minutes
- [BMAD Integration Guide](./riper_docs/bmad_integration_guide.md) - Enterprise adoption
- [Integration Tests](./riper_docs/integration_tests.md) - Test scenarios and examples
- [MCP Setup Guides](./riper_docs/mcp/) - Individual service setup instructions
